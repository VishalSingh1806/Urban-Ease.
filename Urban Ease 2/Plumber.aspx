<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Plumber.aspx.cs" Inherits="Urban_Ease_2.Services.Plumber" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-3 mb-4" id="sidebar" style="margin-top: 40px; margin-left: -70px; margin-right: 40px">
                <div class="card border-0 shadow" style="border-radius: 15px; overflow: hidden; position: sticky; top: 80px;">
                    <div class="card-body" style="background-color: #f8f9fa; border-radius: 8px; padding: 20px;">
                        ...
                        <h5 class="card-title" style="font-weight: bold; color: #333; font-size: 24px; margin-bottom: 10px;">Electricians, Plumber & Carpenter</h5>
                        <hr style="margin-bottom: 20px; border-top: 2px solid #333;" />
                        <h6 class="card-title" style="font-weight: bold; color: #333; font-size: 20px; margin-bottom: 10px;">Home Repair</h6>
                        <div class="row gx-3 gy-3">
                            <!-- Image Buttons -->
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/r1.png" class="img-fluid rounded" alt="Electrician" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; white-space: nowrap; line-height: 1.4; overflow-wrap: break-word; overflow: hidden; text-overflow: ellipsis; font-size: 14px; margin-top: 8px;">Electrician</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/r2.png" class="img-fluid rounded" alt="Plumber" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Plumber</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/r3.png" class="img-fluid rounded" alt="Carpenter" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Carpenter</p>
                                </a>
                            </div>
                            <hr style="margin: 20px 0; border-top: 2px solid #333;" />
                            <h6 class="card-title" style="font-weight: bold; color: #333; font-size: 20px; margin-bottom: 10px;">Home Installation</h6>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/i1.png" class="img-fluid rounded" alt="Ceiling fan Installation" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Ceiling fan Installation</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/i2.png" class="img-fluid rounded" alt="Furniture Assembly" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Furniture Assembly</p>
                                </a>
                            </div>
                ...
                <div id="pictureCarousel" class="carousel slide mb-4 mt-4" data-bs-ride="carousel" data-interval="3000" style="border-radius: 15px; overflow: hidden;">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1696597422886-e55082.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1696597427905-d863f8.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1696597433582-3862c8.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1695987497854-a8aaac.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1695987473655-4902f7.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
    ...
    <!-- JavaScript to adjust sidebar position dynamically -->
    <script>
