<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Woman.aspx.cs" Inherits="Urban_Ease_2.Services.Woman" %>
            ...
            <div class="col-md-3 mb-4" id="sidebar" style="margin-top: 40px; margin-left: -70px; margin-right: 40px">
                <div class="card border-0 shadow" style="border-radius: 15px; overflow: hidden; position: sticky; top: 80px;">
                    <div class="card-body" style="background-color: #f8f9fa; border-radius: 8px; padding: 20px;">
                        ...
                        <h5 class="card-title" style="font-weight: bold; color: #333; font-size: 24px; margin-bottom: 10px;">Salon Prime</h5>
                        <hr style="margin-bottom: 20px; border-top: 2px solid #333;" />

                        <div class="row gx-3 gy-3">
                            <!-- Image Buttons -->
                            <div class="col-4">
                                <a href="#Pedicure" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/w1.png" class="img-fluid rounded" alt="Pedicure" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                            ...
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/w2.png" class="img-fluid rounded" alt="Manicure" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Manicure</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/w3.png" class="img-fluid rounded" alt="Facial & Cleanup" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Facial & Cleanup</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/w4.png" class="img-fluid rounded" alt="Hair Care" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Hair Care</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/w5.png" class="img-fluid rounded" alt="Bleach & Detan" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Bleach & Detan</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/w6.png" class="img-fluid rounded" alt="Threading & Waxing" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Threading & Waxing</p>
                                </a>
                            </div>
                            <!-- Add more sidebar items as needed -->
                            <hr style="margin-top: 20px; border-top: 2px solid #333;" />
                            <div class="col-12">
                ...
                <div id="pictureCarousel" class="carousel slide mb-4 mt-4" data-bs-ride="carousel" data-interval="3000" style="border-radius: 15px; overflow: hidden;">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="images/womans.png" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 1">
                        </div>
