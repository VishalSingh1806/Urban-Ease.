...
namespace Urban_Ease_2.Services
{
    public partial class Woman : System.Web.UI.Page
    {
        ...
        protected void PopulateItems()
        {
            try
            {
                ...
                selectCmd.Parameters.AddWithValue("@category", "Woman's Section");
...
<div class='card shadow-lg mb-4' style='border-radius: 20px; overflow: hidden; background: linear-gradient(145deg, #2c3e50, #3498db);'>
    <div class='row g-0'>
        <div class='col-md-6' style='position: relative;'>
            ...
            {(string.IsNullOrEmpty(base64Image) ? "<div class='placeholder-image' style='height: 100%; background: #ecf0f1; display: flex; align-items: center; justify-content: center;'><span style='color: #7f8c8d;'>No Image</span></div>" : $"<img src='data:image;base64,{base64Image}' class='img-fluid' style='height: 100%; width: 100%; object-fit: cover; background-color: #ecf0f1;' alt='Service Image'>")}
