<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="man.aspx.cs" Inherits="Urban_Ease_2.man" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 mb-4" id="sidebar" style="margin-top: 40px; margin-left: -70px; margin-right: 40px">
                <div class="card border-0 shadow" style="border-radius: 15px; overflow: hidden; position: sticky; top: 80px;">
                    <div class="card-body" style="background-color: #f8f9fa; border-radius: 8px; padding: 20px;">
                        ...
                        <h5 class="card-title" style="font-weight: bold; color: #333; font-size: 24px; margin-bottom: 10px;">Gentlemen's Corner</h5>
                        <hr style="margin-bottom: 20px; border-top: 2px solid #333;" />
                        <div class="row gx-3 gy-3">
                            <!-- Image Buttons -->
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/1.png" class="img-fluid rounded" alt="Pedicure" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; white-space: nowrap; line-height: 1.4; overflow-wrap: break-word; overflow: hidden; text-overflow: ellipsis; font-size: 14px; margin-top: 8px;">Pedicure</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/2.png" class="img-fluid rounded" alt="Men / Kids Haircut" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Men / Kids Haircut</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/3.png" class="img-fluid rounded" alt="Face Care" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Face Care</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/4.png" class="img-fluid rounded" alt="Shave / Beard Grooming" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Shave / Beard Grooming</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/5.png" class="img-fluid rounded" alt="Hair Color" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Hair Color</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/6.png" class="img-fluid rounded" alt="Massage" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Massage</p>
                                </a>
                            </div>
            ...
            <!-- Main Content Area with Carousel and Options -->
                ...
                <div id="pictureCarousel" class="carousel slide mb-4 mt-4" data-bs-ride="carousel" data-interval="3000" style="border-radius: 15px; overflow: hidden;">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1701164387231-cfb845.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1707111431967-1eae92.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1695975571916-5406fc.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1680205379935-013a92.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1680205389547-01a100.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
