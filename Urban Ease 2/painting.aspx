<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="painting.aspx.cs" Inherits="Urban_Ease_2.Services.painting" %>
            ...
            <div class="col-md-3 mb-4" id="sidebar" style="margin-top: 40px; margin-left: -70px; margin-right: 40px">
                <div class="card border-0 shadow" style="border-radius: 15px; overflow: hidden; position: sticky; top: 80px;">
                    <div class="card-body" style="background-color: #f8f9fa; border-radius: 8px; padding: 20px;">
                        ...
                        <h5 class="card-title" style="font-weight: bold; color: #333; font-size: 24px; margin-bottom: 10px;">Painting & Waterproofing</h5>
                        <hr style="margin-bottom: 20px; border-top: 2px solid #333;" />
                        <div class="row gx-3 gy-3">
                            <!-- Image Buttons -->
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/painting.png" class="img-fluid rounded" alt="Full House Painting" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; white-space: nowrap; line-height: 1.4; overflow-wrap: break-word; overflow: hidden; text-overflow: ellipsis; font-size: 14px; margin-top: 8px;">Full House Painting</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/h-painting.png" class="img-fluid rounded" alt="2 Rooms Painting" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">2 Rooms Painting</p>
                                </a>
                            </div>
                ...
                <div id="pictureCarousel" class="carousel slide mb-4 mt-4" data-bs-ride="carousel" data-interval="3000" style="border-radius: 15px; overflow: hidden;">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="https://thumbs.dreamstime.com/b/team-diverse-professional-hardworking-mixed-race-cleaners-cleaning-service-working-together-modern-luxury-house-using-212925387.jpg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="https://img.freepik.com/free-photo/side-view-woman-working-spa_23-2150911791.jpg?size=626&ext=jpg&ga=GA1.1.1803636316.1707782400&semt=ais" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
