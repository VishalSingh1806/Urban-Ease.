<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="repair.aspx.cs" Inherits="Urban_Ease_2.electronics" %>
            ...
            <div class="col-md-3 mb-4" id="sidebar" style="margin-top: 40px; margin-left: -70px; margin-right: 40px">
                <div class="card border-0 shadow" style="border-radius: 15px; overflow: hidden; position: sticky; top: 80px;">
                    <div class="card-body" style="background-color: #f8f9fa; border-radius: 8px; padding: 20px;">
                        ...
                        <h5 class="card-title" style="font-weight: bold; color: #333; font-size: 24px; margin-bottom: 10px;">Electronics & Repair</h5>
                        <hr style="margin-bottom: 20px; border-top: 2px solid #333;" />
                        <div class="row gx-3 gy-3">
                            <!-- Image Buttons -->
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/e1.png" class="img-fluid rounded" alt="Cooler Repair" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; white-space: nowrap; line-height: 1.4; overflow-wrap: break-word; overflow: hidden; text-overflow: ellipsis; font-size: 14px; margin-top: 8px;">Cooler Repair</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/e2.png" class="img-fluid rounded" alt="Chimney Repair" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Chimney Repair</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/e3.png" class="img-fluid rounded" alt="Geyser Repair" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Geyser Repair</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/e4.png" class="img-fluid rounded" alt="Laptop Repair" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Laptop Repair</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/e5.png" class="img-fluid rounded" alt="Microwave Repair" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Microwave Repair</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/e6.png" class="img-fluid rounded" alt="Fridge Repair" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Fridge Repair</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/e7.png" class="img-fluid rounded" alt="TV Repair" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">TV Repair</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/e8.png" class="img-fluid rounded" alt="Water Purifier Repair" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Water Purifier Repair</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="d-block text-center" style="text-decoration: none;">
                                    <img src="images/e9.png" class="img-fluid rounded" alt="Washing Machine Repair" style="max-width: 80%; height: auto; transition: transform 0.2s;">
                                    <p style="font-weight: 500; color: #555; text-align: center; font-size: 14px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; margin-top: 8px;">Washing Machine Repair</p>
                                </a>
                            </div>
                ...
                <div id="pictureCarousel" class="carousel slide mb-4 mt-4" data-bs-ride="carousel" data-interval="3000" style="border-radius: 15px; overflow: hidden;">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1695976116274-c8e39f.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1695976134531-582422.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1695976125911-55a4a2.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1710841141368-1642c2.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_873,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1710322828550-146ca1.jpeg" class="d-block w-100" style="object-fit: cover; height: 500px;" alt="Image 2">
                        </div>
